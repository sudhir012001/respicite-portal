...
for($j=0;$j<count($p2);$j++)
{
    ...
    else
    {
        ...
        else if($p2_per[$j]>50 && $p2_per[$j]<60)
        {
        ...
        else if($p2_per[$j]>=60 && $p2_per[$j]<=85)
        {
...
for($j=0;$j<count($p3);$j++)
{
    ...
    
    {
        ...
        else if($p3_per[$j]>50 && $p3_per[$j]<60)
        {
        ...
        else if($p3_per[$j]>=60 && $p3_per[$j]<=85)
        {
...
//Check if there are any inferences
$ct_inf = count($needs_s);
if($ct_inf > 0)
{
