...
// Interest Mapper
    ...
    
    {
        ...
        foreach($arr_b['Top Choice'] as $temp_x)
        {
                ...
                {
                   $sql_choice_top = "select * from career_sui_latest where Cluster = '$clstr' AND recommendation='Top Choice' AND code='$code'";
        ...
        if($cnt_profs >= $careers_to_disp)
         ...
         if ($cnt_profs < $careers_to_disp)
         {
            foreach($arr_b['Good Choice'] as $temp_x)
            {
                    ...
                    {
                       $sql_choice_good = "select * from career_sui_latest where Cluster = '$clstr' AND recommendation='Good Choice' and code='$code'";
          ...
          foreach($arr_b['Optional'] as $temp_x)
            {
                    ...
                    {
                       $sql_choice_opt = "select * from career_sui_latest where Cluster = '$clstr' AND recommendation='Optional' and code='$code'";
           ...
           foreach($arr_b['Develop'] as $temp_x)
            {
                    ...
                    {
                       $sql_choice_dev = "select * from career_sui_latest where Cluster = '$clstr' AND recommendation='Develop' and code='$code'";
           ...
           foreach($arr_b['Explore'] as $temp_x)
            {
                    ...
                    {
                       $sql_choice_exp = "select * from career_sui_latest where Cluster = '$clstr' AND recommendation='Explore' and code='$code'";
    ...
    */
    ...
    //while($row_cnt = mysqli_fetch_array($res_cnt))
    {
        ...
        $clust_ctr += 1;
        if($clusters_to_display >5)
        {
            $clusters_to_display = 5;
            break;
        }
