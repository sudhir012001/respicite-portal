    ...
    <section class="content">
      ...
      <form action="" method="post">
            ...
            <?php 
                ...
                {  
                    ...
                    <div class="icheck-success">
                        <input type="checkbox" id="cb<?php echo $i; ?>" value="<?php echo $row->id; ?>" name="cb[]">
        ...
        <div class="row">
          ...
          <!-- /.col -->
          <div class="col-4">
            <button type="submit" name="save_level2" class="btn btn-primary btn-block">Save & Next</button>
          </div>
          <!-- /.col -->
        </div>
      </form>
