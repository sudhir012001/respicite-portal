...
<div class="content-wrapper bg-white" style="min-height: 706px">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right pt-1">
            <li class="breadcrumb-item">
              <a href="<?php echo base_url();?>SpController/dashboard"
                >Dashboard</a
              >
            </li>
  ...
  <section class="content ">
    <div class="container-fluid">      
          <p class="text-right"><a class="btn btn-sm btn-outline-primary" href="<?php echo base_url('SpController/job_add');?>">Add New Job</a></p>
                  ...
                  <tbody>
                    ...
                    if(!empty($short_data)){
                      ...
                      <tr>
                        ...
                        <td>
                            <a class='btn btn-sm btn-outline-info m-1' href='<?php echo base_url('SpController/job_edit/'.$v->id);?>'>Edit</a>
                        ...
                        <td>
                        <a class='btn btn-sm btn-outline-info m-1' href='<?php echo base_url('SpController/job_request_user/'.$v->id);?>'>click here</a>
                        </td>
                      </tr>
                      <?php 
                      }
...
<script>
  ...
  $(document).on("click",".btn-delete-this",function(){
    ...
    if(confirm("Are you sure you want to delete?")){
        $.get(`${BASE_URL}SpController/delete_itme/${jid}/REMOVE_JOB`,function(res){
  ...
  $(document).on("click",".btn-status-this",function(){
    ...
    var this_box = $(this).parent();
        $.get(`${BASE_URL}SpController/ajax_work/${jid}/JOB_STATUS`,function(res){
          let res_json = JSON.parse(res);
          if(res_json.MSG == "OK"){
