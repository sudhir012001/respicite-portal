            ...
            <div class="form-row">
              <div class="col-md-4 mb-3 ">
                <select class="form-control" name="levelone" id="levelone">
                  ...
                  <?php 
                     $lk = $this->Admin_model->provider_level_list();
            ...
            <div class="col-12 col-sm-6 col-md-4 d-flex align-items-stretch flex-column">
              <div class="card bg-light d-flex flex-fill">
                ...
                <div class="text-right">
                  ...
                  <a style="cursor: pointer;" class="btn btn-sm btn-primary open-homeEvents" href="<?php echo base_url().'SpController/view_sp_full_detail/'.base64_encode($row->email); ?>" >
...
<script type=text/javascript>
   ...
   $(document).ready(function(){
    ...
    $('#levelone').change(function(){ 
     ...
     $.ajax({
            type : 'post',
            url : '<?php echo base_url()."OtherAjax/fetch_sp_detail.php"; ?>', //Here you will fetch records 
