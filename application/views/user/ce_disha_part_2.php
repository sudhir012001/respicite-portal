      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <!-- Profile Image -->
            <div class="bg-white rounded border-round shadow mt-4 mb-5">
      ...
      <div class="col-sm-12">
            ...
            <?php 
              ...
              $pref_opt_ctr=0;
                ...
                foreach($q->result() as $q)
                {
                    ...
                    $que_disp_ctr = $que_disp_ctr + 1;
                    //echo "counter :".$que_disp_ctr;
           ...
           <p><b><?php echo 'Q. '.$q->qno.'. '.$q->item; ?></b></p>
            ...
            <div class="form-group clearfix">
                      <!-- update code by Danish START. -->
                        <?php
                            $assessment = $q->set_name;                            
                            $opt = array();
                            $val = array();
                            array_push($opt,$q->opt_1);
                            array_push($opt,$q->opt_2);
                            array_push($val,'1');
                            array_push($val,'2');
                            $ctr = count($opt);
                            //echo "Assessment Type :".$assessment."<br>";
                          ...
                          ?>
                            <div class="icheck-success">
                                <input type="radio" name="<?php echo 'radio'.$i; ?>" value='<?php echo $val[$k]; ?>' id="<?php echo $q->qno.'o'.$val[$k]; ?>">
                                <label for="<?php  echo $q->qno.'o'.$val[$k]; ?>">
                                    <?php echo $opt[$k]; ?>
                                </label>
                            </div>
                        <?php } ?>
