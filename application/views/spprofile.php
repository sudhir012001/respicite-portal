        ...
        <div class="card-body">
          <div class="row">
            ...
            <div class="col-12 col-sm-6">
              ...
              <h3 class="my-3">About Us (100 words)</h3>
              <div class="form-group">
                <textarea class="form-control" rows="3" name="aboutus" id="aboutus" placeholder="Enter ..."><?php echo $about_us; ?></textarea>
              </div>
          ...
          <div class="row mt-4">
            <nav class="w-100">
              <div class="nav nav-tabs" id="product-tab" role="tablist">
                ...
                <a class="nav-item nav-link" id="product-rating-tab" data-toggle="tab" href="#product-rating" role="tab" aria-controls="product-rating" aria-selected="false">More About us</a>
              </div>
            </nav>
