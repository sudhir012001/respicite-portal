              ...
              <div class="m-2 border shadow rounded">
                      ...
                      <div class="card-body">
                        ...
                        <?php if(!empty($vocational_info)){
                          ...
                          <form action="<?php echo base_url('UserController/vocational_training_edit/'.$vocational_data->id.'/VOC_TRAI');?>" method="post">
              ...
              <?php if(!empty($vocational_info)){
                  ...
                  <div class="col-md-6">
                        <div class="card m-2 border shadow rounded">
                          ...
                          <div class="card-body">
                          <form action="<?php echo base_url('UserController/vocational_training_edit/'.$v->training_id.'/SUB_SECTION?sno='.$v->id);?>" method="post">
                            <div class="form-group">
                  ...
                  <form action="<?php echo base_url('UserController/vocational_training_edit/'.$vocational_data->id.'/ADD_SUB_SECTION');?>" method="post" class="col-md-12 row repeat-section"  id="form_add_more">                  
          ...
          <div class="card-body">
                    <div class="row">
                      ...
                      <div class="col-md-6"> 
                        ...
                        ?>
                        <form action="<?php echo base_url('UserController/vocational_training_edit/'.$vocational_data->id.'/CONTENT_UPLOAD');?>" method="post" enctype="multipart/form-data">        
                            <div class="form-group">
                              <label for="exampleInputFile">Upload Training Content</label>
 ...
 $(".btn-repeat-section").click(function(){ 
  ...
  $(document).on("click",".btn-delete",function(){
    ...
    if(confirm("Are you sure you want to delete?")){
      $.get(`${BASE_URL}UserController/delete_itme/${section_id}/REMOVE_SUB_SECTION`,function(res){
