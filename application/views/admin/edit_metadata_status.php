<body class="hold-transition login-page">
    ...
    <section class="content-header mb-3" style="padding: 6px 0.5rem;background-color: #ffffff;border-bottom: 1px solid #dee2e6;">
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
          <h1 class="m-0 pt-2" style="font-size: 1.2em;color: #7f7f7f;">Edit Status for <?php echo $name; ?></h1>
          </div>
          <div class="col-sm-6">
    ...
    <section class="content">
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary card-outline">
                ...
                <h3 class="profile-username text-center">Edit Status for <?php echo $name; ?></h3>
                <?php 
      ...
      <form action="<?php echo base_url('AdminController/updateStatus/') ?>" method="post">
        <div class="form-group">

            <select class="form-control" name="status">
          
            <option value="">Select Status</option>
            <option value="dev" <?php  echo $status=='dev'?'selected' : ''?>>Development</option>
