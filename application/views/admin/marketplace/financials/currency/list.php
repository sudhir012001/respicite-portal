...
<div class="content-wrapper">
    ...
    <section class="content-header mb-3" style="padding: 6px 0.5rem;background-color: #ffffff;border-bottom: 1px solid #dee2e6;">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
          <h1 class="m-0 pt-2" style="font-size: 1.2em;color: #7f7f7f;">Currency List</h1>
          </div>
          <div class="col-sm-6">
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                ...
                <button class="btn btn-primary" onclick="addFlow(<?php echo $currency[0]['id']?> )" style="float: right;">Add Currency</button>
              </div> 
              <!-- /.card-header -->
              ...
              <div class="card-body table-responsive p-0">
               ...
               <tr>  
                    ...
                    <!--   <td><?php //echo $flow[0]['controller'];?></td>  -->
                      <td>
                    <?php //$parameter= explode(",",$currency[0]['parameter']);
                  ...
                  <td>
                    ...
                    <?php //$parameter= explode(",",$category[0]['parameter']);
                          foreach($paramdata as $k3=>$v3){
                              $id=base64_encode($currency[0]['id']);
                              $k=base64_encode($v3['key']);
                              $mdata=base64_encode('Currency');
                      ?> 
                      <table class="table table-bordered border-bottom border-top">
                        <tbody>
                          
                          <tr style="width:30%"><button class="btn btn-info btn-xs" onclick="editParameter('<?php echo $id ?>','<?php echo $k ?>','<?php echo $mdata ?>','<?php echo $v3['parameter'] ?>', '<?php echo $v3['desc'] ?>')">Edit <?php echo $v3['parameter'] ?> Parameter</button></tr>
                    ...
                    <?php } ?>
                      ...
                      <td><?php echo $currency[0]['status'];?><br><a class="btn btn-info" href="<?php echo base_url().'AdminController/editStatus/'.$currency[0]['id'];?>">Edit Status</a></td>  
                  </tr>  
              ...
              <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <form action="<?php echo base_url("AdminController/addCurrency");?>" method="post" enctype="multipart/form-data">
                        <div class="row">
                          <div class="col-md-12">
                            <div class="mb-3">
                       ...
                       <input type="hidden" name="id" value="<?php echo $currency[0]['id']?>">
                      </div>
            ...
            <div class="modal fade" id="editParameter" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
              <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <form action="<?php echo base_url("AdminController/updateCurrency");?>" method="post" enctype="multipart/form-data">
                      <!--  <div class="row">-->
                      <!--    <div class="col-md-12">-->
                      <!--      <div class="mb-3">-->
                      <!--        <label class="form-label" for="basic-default-fullname">Parameter Name</label>-->
