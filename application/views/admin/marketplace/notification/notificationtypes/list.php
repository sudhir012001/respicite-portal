...
<div class="content-wrapper">
    ...
    <section class="content-header mb-3" style="padding: 6px 0.5rem;background-color: #ffffff;border-bottom: 1px solid #dee2e6;">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
          <h1 class="m-0 pt-2" style="font-size: 1.2em;color: #7f7f7f;">Notification Type List</h1>
          </div>
          <div class="col-sm-6">
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Notification Type List</h3>
                ...
                <button class="btn btn-primary" onclick="addFlow(<?php echo $notification[0]['id']?> )" style="float: right;">Add Notification Type</button>
              </div> 
              <!-- /.card-header -->
              ...
              <div class="card-body table-responsive p-0">
               ...
               <tr>  
                      <td><?php echo $notification[0]['name'];?></td>  
                    <!--   <td><?php //echo $flow[0]['controller'];?></td>  -->
                      <td>
                    <?php $parameter= explode(",",$notification[0]['parameter']);
                    ...
                    <?php $parameter= explode(",",$notification[0]['parameter']);
                          foreach($parameter as $k=>$v){
                              $id=base64_encode($notification[0]['id']);
                              $k=base64_encode($k);
                              $mdata=base64_encode('Notification Types');
                      ?> 
                      <table class="table table-bordered border-bottom border-top">
                        <tbody>
                          ...
                          <tr><button class="btn btn-info btn-xs mx-3" onclick="editParameter('<?php echo $id ?>','<?php echo $k ?>','<?php echo $mdata ?>','<?php echo $v ?>')">Edit <?php echo $v ?> Parameter</button>
                          
                          <a class="btn btn-danger btn-xs" onclick="deleteParameter()" href="<?php echo base_url().'AdminController/deleteParameter?id='.$id.'&key='.$k.'&parameter='.$v.'&name='.$mdata;?>">Delete <?php echo $v ?> Parameter</a>
                    ...
                    <?php } ?>
                      ...
                      <td><?php echo $notification[0]['status'];?><br><a class="btn btn-info" href="<?php echo base_url().'AdminController/editStatus/'.$notification[0]['id'];?>">Edit Status</a></td>  
                  </tr>  
              ...
              <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <form action="<?php echo base_url("AdminController/addNotificationType");?>" method="post" enctype="multipart/form-data">
                        <div class="row">
                          <div class="col-md-12">
                            <div class="mb-3">
                       ...
                       <input type="hidden" name="id" value="<?php echo $notification[0]['id']?>">
                      </div>
