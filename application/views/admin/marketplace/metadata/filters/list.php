...
<div class="content-wrapper">
    ...
    <section class="content-header mb-3" style="padding: 6px 0.5rem;background-color: #ffffff;border-bottom: 1px solid #dee2e6;">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
          <h1 class="m-0 pt-2" style="font-size: 1.2em;color: #7f7f7f;">Filter List</h1>
          </div>
          <div class="col-sm-6">
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                ...
                <button class="btn btn-primary" onclick="addFlow(<?php echo $filters[0]['id']?> )" style="float: right;">Add Filter Parameter</button>
              </div> 
              <!-- /.card-header -->
              ...
              <div class="card-body table-responsive p-0">
               ...
               <tr>  
                      <td><?php echo $filters[0]['name'];?></td>  
                    <!--   <td><?php //echo $sp[0]['controller'];?></td>  -->
                      <td>
                    <?php $parameter= explode(",",$filters[0]['parameter']);
                ...
                <td>
                    <?php $parameter= explode(",",$filters[0]['parameter']);
                          foreach($parameter as $k=>$v){
                              $id=base64_encode($filters[0]['id']);
                              $k=base64_encode($k);
                              $mdata=base64_encode('Filters');
                      ?> 
                      <table class="table table-bordered border-bottom border-top">
                        <tbody>
                    ...
                    <?php } ?>
                      ...
                      <td><?php echo $filters[0]['status'];?><br><a class="btn btn-info" href="<?php echo base_url().'AdminController/editStatus/'.$filters[0]['id'];?>">Edit</a></td>  
                  </tr>  
              ...
              <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                  <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Add Filter Parameter</h5>
                    <button type="button" onclick="addFlowClose()" class="close btn btn-danger" data-dismiss="modal" aria-label="Close">
                      <span aria-hidden="true">&times;</span>
                    </button>
                  </div>
                  <div class="modal-body">
                    <form action="<?php echo base_url("AdminController/addFilterParameter");?>" method="post" enctype="multipart/form-data">
                        <div class="row">
                          <div class="col-md-12">
                            <div class="mb-3">
                       ...
                       <input type="hidden" name="id" value="<?php echo $filters[0]['id']?>">
                      </div>
