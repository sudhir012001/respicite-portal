...
<div class="content-wrapper">
    ...
    <section class="content-header mb-3" style="padding: 6px 0.5rem;background-color: #ffffff;border-bottom: 1px solid #dee2e6;">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
          <h1 class="m-0 pt-2" style="font-size: 1.2em;color: #7f7f7f;">SP Progress Status List</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right pt-1">
              <li class="breadcrumb-item"><a href="<?php echo base_url("AdminController/dashboard");?>">Dashboard</a></li>
              <li class="breadcrumb-item active">SP Progress Status List</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">SP Progress Status List</h3>
                ...
                <button class="btn btn-primary" onclick="addFlow(<?php echo $sp[0]['id']?> )" style="float: right;">Add SP Parameter</button>
              </div> 
              <!-- /.card-header -->
              ...
              <div class="card-body table-responsive p-0">
               ...
               <tr>  
                    ...
                    <!--   <td><?php //echo $sp[0]['controller'];?></td>  -->
                      <td>
                    <?php $parameter= explode(",",$sp[0]['parameter']);
                    ...
                    <?php $parameter= explode(",",$sp[0]['parameter']);
                          foreach($parameter as $k=>$v){
                              $id=base64_encode($sp[0]['id']);
                              $k=base64_encode($k);
                              $mdata=base64_encode('SP');
                      ?> 
                      <table class="table table-bordered border-bottom border-top">
                        <tbody>
                    ...
                    <?php } ?>
                      ...
                      <td><?php echo $sp[0]['status'];?><br><a class="btn btn-info" href="<?php echo base_url().'AdminController/editStatus/'.$sp[0]['id'];?>">Edit</a></td>  
                  </tr>  
              ...
              <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                  <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Add SP Progress Status Parameter</h5>
                    <button type="button" onclick="addFlowClose()" class="close btn btn-danger" data-dismiss="modal" aria-label="Close">
                      <span aria-hidden="true">&times;</span>
                    </button>
                  </div>
                  <div class="modal-body">
                    <form action="<?php echo base_url("AdminController/addSpParameter");?>" method="post" enctype="multipart/form-data">
                        <div class="row">
                          <div class="col-md-12">
                            <div class="mb-3">
