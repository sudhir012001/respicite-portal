<body class="hold-transition login-page">
    ...
    <section class="content-header mb-3" style="padding: 6px 0.5rem;background-color: #ffffff;border-bottom: 1px solid #dee2e6;">
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
          <h1 class="m-0 pt-2" style="font-size: 1.2em;color: #7f7f7f;">Add Package</h1>
          </div>
          <div class="col-sm-6">
    ...
    <section class="content">
      ...
      <form action="<?php echo base_url('AdminController/insert_package') ?>" method="post">
        <div class="form-group">

            <select class="form-control" name="solution_name" id="<?php echo set_value('solution_name'); ?>" placeholder="Solution Name" onchange="changeThis(<?php echo $row->id; ?>)">
            <option value="">Solution Name</option>
            <?php 
                foreach($s->result() as $row)
                {
                    
                    ?>
                    <option value="<?php echo $row->solution; ?>"><?php echo $row->solution; ?></option>
                    <?php
                }
                 ?>
        ...
        <div class="row">
          ...
          <!-- /.col -->
          <div class="col-4">
            <button type="submit" name="add_package_btn" class="btn btn-primary btn-block">Add Package</button>
          </div>
          <!-- /.col -->
        </div>
      </form>
