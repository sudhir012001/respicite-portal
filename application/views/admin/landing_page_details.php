...
<div class="content-wrapper">
    ...
    <section class="content-header mb-3" style="padding: 6px 0.5rem;background-color: #ffffff;border-bottom: 1px solid #dee2e6;">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
          <h1 class="m-0 pt-2" style="font-size: 1.2em;color: #7f7f7f;">Landing Section Details List</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right pt-1">
              <li class="breadcrumb-item"><a href="<?php echo base_url("AdminController/dashboard");?>">Dashboard</a></li>
              <li class="breadcrumb-item active">Landing Section Details List</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Landing Section Details List</h3>
                ...
                <button class="btn btn-primary" onclick="addFlow(<?php echo $flow[0]['id']?> )" style="float: right;">Add Landing Section Details </button>
              </div> 
              <!-- /.card-header -->
              ...
              <div class="card-body table-responsive p-0">
                <table class="table table-bordered text-nowrap">
                  ...
                  foreach($flow as $row2) { ?>
                    ...
                    <td><button class="btn btn-info btn-xs" onclick="editParameter('<?php echo $row2['name'] ?>','<?php echo $row2['descripation'] ?>','<?php echo $row2['path'] ?>','<?php echo $row2['id'] ?>')">Edit </button></td>  
                    <td><a class="btn btn-info" href="<?php echo base_url().'AdminController/landingDelete/'.$row2['id'];?>" onclick="return confirm('Are you sure you want to delete this item?');">Delete</a></td>   
