      ...
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 pt-2" style="font-size: 1.2em; color: #7f7f7f">
            Frequently Asked Questions All View
          </h1>
        </div>
        <div class="col-sm-6">
        ...
        <div class="col-md-12">
          ...
          <div class="card">
            <div class="card-body box-profile">
              <!-- repeat #START -->
              <?php if(!empty($db_data)){ $q_no = 1; foreach($db_data as $rows){?>
              <div class="border p-3 rounded">
                <h3 class="pl-2"><?php echo "Q".$q_no++.". ".$rows->heading; ?></h3>
                <hr class="p-0 m-0" />
                <h4 class="pl-2">
                  <?php echo (!empty($rows->cat_title))?$rows->cat_title:""; ?>
                </h4>
                <p class="pl-2"><b>Ans.</b> <?php echo $rows->description; ?></p>
