<body class="hold-transition login-page">
    ...
    <section class="content">
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary card-outline">
                ...
                <p class="text-muted text-center">Rayzorpay credential</p> 
      ...
      <form action="" method="post">
        ...
        <div class="input-group mb-3">
          <input type="text" class="form-control <?php echo (form_error('api_secret')!="") ? 'is-invalid' : ''; ?>" name="api_secret" value="<?php echo isset($get_payment_details_id_vias->secret_key)? $get_payment_details_id_vias->secret_key:''; ?>" placeholder="API SECRET">
          <!-- <div class="input-group-append">
            <div class="input-group-text">
